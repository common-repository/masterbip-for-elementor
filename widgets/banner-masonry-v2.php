...
class MB_Banner_Masonry_v2 extends Widget_Base{
	public function get_name(){
		return 'banner_masonry_v2';
	}
	/*
	* Widget Titulo
	*/
	public function get_title(){
		return __('Banner Masonry V2','masterbip');
	}
	/*
	* Widget Icono
	*/
	...
	*/
	protected function register_controls(){
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .mb-bannerm-v2' => 'height: {{SIZE}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .mb-bannerm-v2' => 'width: {{SIZE}}{{UNIT}};',
				],
			]
		);
		$this->add_control(
	...
	protected function render(){
		...
		$html = '<div class="mb-bannerm-v2">';
		$html .= '<div class="overlay"></div>';
		$html .= '<a '.$this->get_render_attribute_string('link').'>';
		$html .= '<span>'.$settings['title_text'].'</span>';
	...
	protected function content_template(){
		...
		var html = '<div class="mb-bannerm-v2">';
		html += '<div class="overlay"></div>';
